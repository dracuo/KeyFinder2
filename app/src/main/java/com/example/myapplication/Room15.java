...
public class Room15 extends AppCompatActivity {
    EditText eText;
    SharedPreferences sPref;
    final String SAVED_TEXT = "saved_text";//переменные для сохранения текста
    public static int checkkey15;//переменная для проверки наличия ключа

    @Override
    //начало цикла onCreate
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.room15);
       ...
       // w.setFlags(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS, WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Room15.this, Rooms.class);
